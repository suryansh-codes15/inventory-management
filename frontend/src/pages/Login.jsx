...
export default function Login() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] bg-background overflow-hidden" data-testid="login-page">
      ...
      {/* RIGHT: Video backdrop hero */}
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-emerald-950/40 to-slate-900 min-h-[480px] lg:min-h-screen py-12 lg:py-0">
        <video
